...
int64 nChainStartTime = 1374040317;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	else if(rand > 4000 && rand < 4011)	// 10/14400 = 1/1440
	{
		...
		cseed = cseed_str.c_str();
		seed = hex2long(cseed);
		rand1 = generateMTRandom(seed, 6001);
		nSubsidy = (2000 + rand1 - 1) * COIN;
	}
	else 
	{
		cseed_str = prevHash.ToString().substr(6,7);
	...
	// Subsidy is cut in half every 1,051,200 blocks, which will occur approximately every year
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "July 16, 2013 at 9:54 a.m. EDT: A serious water leak inside an astronaut's helmet forced NASA to cut short a spacewalk Tuesday outside the International Space Station";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x2f1b87184c2cd9883b80e0e315de7a4241457a17176b5433a3ef7f1ba6283d03"));
